...
Welcome to `llm-experiments` contributor's guide.
...
If you experience bugs or general issues with `llm-experiments`, please have a look
...
You can help improve `llm-experiments` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`llm-experiments` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `llm-experiments`'s files. While this mechanism can
...
```
conda create -n llm-experiments python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/llm-experiments.git
   cd llm-experiments
   ```
...
5. Install [pre-commit]:
   ...
   `llm-experiments` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/llm-experiments
[issue tracker]: https://github.com/<USERNAME>/llm-experiments/issues
